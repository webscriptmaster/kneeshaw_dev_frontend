    ...
    <main className="flex min-h-screen w-full flex-col">
      ...
      <section className="mb-[100px] mt-[150px] flex w-full flex-col px-5 md:px-10">
        ...
        <p className="mb-10 text-justify text-[16px] md:text-[18px] lg:text-[20px]">
          AGREEMENT TO OUR LEGAL TERMS We are Kneeshaw Developments
          LLC("Company," "we," "us," "our"). We operate the website{" "}
          <a
          ...
          the "Services"). Video Game Software, Web and software development
          ...
          Kneeshaw Developments LLC, concerning your access to and use of the
        ...
        <div className="mb-10 flex flex-col items-center text-[#AFD275]">
          ...
          <ol className="list-inside list-decimal text-[14px] md:text-[16px] lg:text-[18px]">
            ...
            <li>
              <a href="#toc-16" className="text-[16px] font-[500]">
                TERM AND TERMINATION
              </a>
            </li>
            <li>
              <a href="#toc-17" className="text-[16px] font-[500]">
                MODIFICATIONS AND INTERRUPTIONS
              </a>
            </li>
            <li>
              <a href="#toc-18" className="text-[16px] font-[500]">
                GOVERNING LAW
              </a>
            </li>
            <li>
              <a href="#toc-19" className="text-[16px] font-[500]">
                DISPUTE RESOLUTION
              </a>
            </li>
            <li>
              <a href="#toc-20" className="text-[16px] font-[500]">
                CORRECTIONS
              </a>
            </li>
            <li>
              <a href="#toc-21" className="text-[16px] font-[500]">
                DISCLAIMER
              </a>
            </li>
            <li>
              <a href="#toc-22" className="text-[16px] font-[500]">
                LIMITATIONS OF LIABILITY
              </a>
            </li>
            <li>
              <a href="#toc-23" className="text-[16px] font-[500]">
                INDEMNIFICATION
              </a>
            </li>
            <li>
              <a href="#toc-24" className="text-[16px] font-[500]">
                USER DATA
              </a>
            </li>
            <li>
              <a href="#toc-25" className="text-[16px] font-[500]">
                ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
              </a>
            </li>
            <li>
              <a href="#toc-26" className="text-[16px] font-[500]">
                CALIFORNIA USERS AND RESIDENTS
              </a>
            </li>
            <li>
              <a href="#toc-27" className="text-[16px] font-[500]">
                MISCELLANEOUS
              </a>
            </li>
            <li>
              <a href="#toc-28" className="text-[16px] font-[500]">
                CONTACT US
              </a>
            </li>
          </ol>
        ...
        <div className="mb-5 rounded-md border p-5">
          ...
          <p className="text-justify text-[12px] md:text-[14px] lg:text-[16px]">
            ...
            personal, non-commercial use only.Your use of our ServicesSubject to
            your compliance with these Legal Terms, including the "PROHIBITED
            ...
            use.Except as set out in this section or elsewhere in our Legal
            ...
            your request to: help@kneeshaw.dev. If we ever grant you the
            ...
            immediately.Your submissionsPlease review this section and the
            ...
            explicit, false, inaccurate, deceitful, or misleading;• to the
            extent permissible by applicable law, waive any and all moral rights
            to any such Submission;• warrant that any such Submission are
        ...
        <div className="mb-5 rounded-md border p-5">
          ...
          <p className="text-justify text-[12px] md:text-[14px] lg:text-[16px]">
            We accept the following forms of payment:- PayPal You agree to
        ...
        <div className="mb-5 rounded-md border p-5">
          ...
          <p className="text-justify text-[12px] md:text-[14px] lg:text-[16px]">
            ...
            <a
              className="text-[#AFD275]"
              href="https://www.kneeshaw.dev/privacy"
              target="_blank"
            >
              https://www.kneeshaw.dev/privacy
            </a>
        ...
        <div className="mb-5 rounded-md border p-5">
          ...
          <p className="text-justify text-[12px] md:text-[14px] lg:text-[16px]">
            Informal NegotiationsTo expedite resolution and control the cost of
            ...
            (AAA) website. Your arbitration fees and your share of arbitrator
            ...
            law, the arbitration will take place in United States, Michigan.
            ...
            entered by the arbitrator.If for any reason, a Dispute proceeds in
            ...
            Michigan, and the Parties hereby consent to, and waive all defenses
            ...
            ArbitrationThe Parties agree that the following Disputes are not
